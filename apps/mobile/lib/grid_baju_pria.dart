...
class _GridBajuPriaState extends State<GridBajuPria> {
  ...
  Future<void> _fetchProducts() async {
    final response = await http.get(Uri.parse('${dotenv.env['BASE_URL']}/products?category=baju pria'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Baju Pria', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
