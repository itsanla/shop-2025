...
class _GridBajuWanitaState extends State<GridBajuWanita> {
  ...
  Future<void> _fetchProducts() async {
    final response = await http.get(Uri.parse('${dotenv.env['BASE_URL']}/products?category=baju wanita'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Baju Wanita', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
