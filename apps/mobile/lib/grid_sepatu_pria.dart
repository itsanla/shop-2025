...
class _GridSepatuPriaState extends State<GridSepatuPria> {
  ...
  Future<void> _fetchProducts() async {
    final response = await http.get(Uri.parse('${dotenv.env['BASE_URL']}/products?category=sepatu pria'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Sepatu Pria', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
